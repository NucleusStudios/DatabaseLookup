<?php
	...
	if(isset($_SESSION['username'])){
		...
		echo '<div class="alert alert-block alert-danger fade in">
                                ...
                                <center>
                               <h5>You must <a class="btn btn-xs btn-info" href="index.php?site=login">login</a> or <a class="btn btn-xs btn-info" href="index.php?site=register">register</a> to use this website!<br></h5>                                </center>
                            </div>';
	}
